...
<section class="productos page-section" id="productos">
    <div class="container">
        ...
        <h1 class="font-weight-bold">Obra: ---------------</h1><br>
        ...
        <div class="mbr-footer-content " style="height: 150px; padding-top: 50px">
                ...
                <br>
                <br>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusantium minima eos ipsum 
                <br>Teléfonos: 51 (1) 234-2345</p>
        </div>
        ...
        <form action="enviar_mensaje.php" method="post" enctype="multipart/form-data">
                ...
                <div class="text-center text-lg-start mt-4 pt-2" style="margin: auto">
                    <button name="send" type="submit" class="btn btn-primary btn-xl js-scroll-trigger"
                            style="padding-left: 4rem; padding-right: 4rem; background-color: #FF0000; color: white;" >Enviar
                    </button>
                </div>
        </form>
