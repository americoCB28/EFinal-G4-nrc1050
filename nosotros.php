    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3 text-center">
          <div class="mt-5">
            <i class="fa-4x fa-solid fa-rocket mb-4 " style="color: #FF0000;"></i>
            <h3 class="h4 mb-2">MISIÓN</h3>
            <p class="text-muted mb-0">Puedes consultar aquí acerca de nuestra Misión</p>
            <button class="btn btn-primary btn-xl js-scroll-trigger" style="background-color: #FF0000; color: white"  data-toggle="modal" data-target="#fm-modal">
                Saber +
            </button>
      ...
      <div class="col-md-6 col-lg-3 text-center">
          <div class="mt-5">
            <i class="fa-4x fa-solid fa-eye mb-4" style="color: #FF0000;"></i>
          
            <h3 class="h4 mb-2">VISIÓN</h3>
            <p class="text-muted mb-0">Puedes consultar aquí acerca de nuestra Visión</p>
            <button class="btn btn-primary btn-xl js-scroll-trigger" style="background-color: #FF0000; color: white"  data-toggle="modal" data-target="#fm-modal1">
                Saber +
            </button>
        ...
        <div class="col-md-6 col-lg-3 text-center">
          <div class="mt-5">
            <i class="fa-4x fa-solid fa-people-group mb-4 " style="color: #FF0000;"></i>
            <h3 class="h4 mb-2">VALORES</h3>
            <p class="text-muted mb-0">Puedes consultar aquí acerca de nuestros valores</p>
            
            <button class="btn btn-primary btn-xl js-scroll-trigger" style="background-color: #FF0000; color: white" data-toggle="modal" data-target="#fm-modal2">
                Saber +
            </button>
        ...
        <div class="col-md-6 col-lg-3 text-center">
          <div class="mt-5">
            <i class=" fa-4x fa-solid fa-file-circle-check mb-4" style="color: #FF0000;"></i>
        
            <h3 class="h4 mb-2">POLÍTICAS</h3>
            <p class="text-muted mb-0">Puede consultar aquí acerca de nuestras políticas</p>
            <button class="btn btn-primary btn-xl js-scroll-trigger" style="background-color: #FF0000; color: white" data-toggle="modal" data-target="#fm-modal3">
                Saber +
            </button>
